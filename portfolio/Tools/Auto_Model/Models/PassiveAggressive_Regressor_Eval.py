...
class PassiveAggressiveRegressorEval:
    ...
    def tune_and_evaluate(self):
        ...
        model = PassiveAggressiveRegressor(random_state=42, max_iter=1000)
...
if __name__ == "__main__":
    ...
    evaluator = PassiveAggressiveRegressorEval(data_files, hyperparams_range)
