...
class AgglomerativeClusteringEval:
    ...
    def tune_and_evaluate(self):
        ...
        test_labels = self.best_model.fit_predict(self.X_test)
...
if __name__ == "__main__":
    ...
    evaluator = AgglomerativeClusteringEval(data_files, hyperparams_range)
